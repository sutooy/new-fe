...
import { loginBackgroundStyle } from './loginBackground.css'
...
export const LoginIndexBackground = () => {
  ...
  return (
    <svg
      ...
      className={loginBackgroundStyle.svg}
    >
      <defs></defs>
      <title></title>
      <g id="planet">
        <circle
          className={loginBackgroundStyle.cls1}
          cx="505.43"
          cy="78.05"
          r="54.36"
        />
      </g>
      <g className={loginBackgroundStyle.cloud1} id="cloud1">
        <path
          className={loginBackgroundStyle.cls2}
      ...
      <g className={loginBackgroundStyle.cloud2} id="cloud2">
        <path
          className={loginBackgroundStyle.cls2}
      ...
      <g className={loginBackgroundStyle.cloud3} id="cloud3">
        <path
          className={loginBackgroundStyle.cls2}
      ...
      <g id="building">
        ...
        />
        <rect
          className={loginBackgroundStyle.cls3}
          x="550.4"
          y="102.76"
          width="26.34"
          height="52.71"
        ...
        />
        <rect
          className={loginBackgroundStyle.cls4}
          x="629.05"
          y="331.4"
          width="27.41"
          height="55.04"
        ...
        />
        <rect
          className={loginBackgroundStyle.cls5}
          x="527.77"
          y="118.4"
          width="224.8"
          height="4.33"
        ...
        />
        <path
          className={loginBackgroundStyle.cls6}
      ...
      <g id="car-right" transform="translate(-100)">
        ...
        />
        <rect
          className={loginBackgroundStyle.cls7}
          x="264.96"
          y="366.27"
          width="13.78"
          height="0.7"
        ...
        />
        <rect
          className={loginBackgroundStyle.cls8}
          x="264.96"
          y="356.24"
          width="13.78"
          height="0.94"
        ...
        />
        <rect
          className={loginBackgroundStyle.cls9}
          x="283.05"
          y="374.76"
          width="1.56"
          height="2.73"
