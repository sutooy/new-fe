...
import { loginStyle } from '@/features/login/login.css';
import {
  LoginDocument,
  LoginMutation,
  MutationLoginArgs,
    ...
    <div className="base-container">
      ...
      <div className="city-map h-full">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="255 -50 1600 625">
          ...
          <g id="planet">
            <circle
              className={loginStyle.cls1}
              cx="505.43"
              cy="78.05"
              r="54.36"
            />
          </g>
          <g className={loginStyle.cloud1} id="cloud1">
            <path
              className={loginStyle.cls2}
          ...
          <g className={loginStyle.cloud2} id="cloud2">
            <path
              className={loginStyle.cls2}
          ...
          <g className={loginStyle.cloud3} id="cloud3">
            <path
              className={loginStyle.cls2}
